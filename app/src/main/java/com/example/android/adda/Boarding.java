...
public class Boarding extends FragmentActivity implements View.OnClickListener {
    ...
    public static Activity boardingacty;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSkip.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(Boarding.this,SetUpUsernameActivity.class));
            }
        });
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            int[] texts = {R.string.fragment1,R.string.fragment2,R.string.fragment3};
